...
function verwijder_back_to_blog_link() {
    echo '<style type="text/css">.login #backtoblog { display:none; }</style>';
}
add_action('login_enqueue_scripts', 'verwijder_back_to_blog_link');

function wijzig_loginpagina_logo() {
    echo '<style type="text/css">
        .login h1 a {
            background-image: url(' . get_template_directory_uri() . '/img/local/logo25jaar.png) !important;
            width: 100% !important;
