        ...
        <div class="relative overflow-hidden">
            <div class="container relative">
                ...
                <div class="w-full md:w-[400px] lg:w-[517px] mx-auto relative z-[2]">
                   <!-- FORMULIER -->
                    <h1 class="text-60 leading-60 md:text-86 md:leading-86 lg:text-111 lg:leading-111 uppercase font-semibold text-[#709138]"><?php the_field("troost_titel_$get_number_month", 'option');?></h1>
                    <div class="min-h-[70px]">
                        <div class="text-16 leading-26 text-white font-light tracking-wide mt-2 px-[10px]"><?php the_field("troost_tekst_$get_number_month", 'option');?></div>
